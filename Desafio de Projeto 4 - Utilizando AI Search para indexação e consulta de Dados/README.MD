...
Nesta apresentação, compartilharei os resultados que obtive ao completar o Desafio de Busca com IA, disponível no Github da Microsoft Learning. Através de dois laboratórios, explorei o poder da IA para aprimorar a experiência de busca.

**Desafio:**
- [MSLearn](https://microsoftlearning.github.io/mslearn-ai-fundamentals/Instructions/Labs/11-ai-search.html)

**Objetivos:**

-   **Compreender os fundamentos da busca com IA.**
-   **Aplicar técnicas de IA para melhorar a relevância e a personalização da busca.**
-   **Desenvolver habilidades práticas em ferramentas de IA como o Azure Cognitive Search e o Azure Machine Learning.**

**Azure AI Search:**

-   **Indexação de dados:**  Indexar dados de diversas fontes para pesquisa rápida.
-   **Consultas complexas:**  Criar consultas complexas para encontrar informações específicas.
-   **Personalização:**  Personalizar resultados de pesquisa para cada usuário.
-   **Enriquecimento de dados:**  Adicionar informações relevantes aos resultados da pesquisa.

**Azure Storage:**

-   **Armazenamento Blob:**  Armazenar grandes quantidades de dados não estruturados.
-   **Armazenamento de arquivos:**  Armazenar arquivos e pastas na nuvem.
-   **Armazenamento de discos:**  Criar discos virtuais para máquinas virtuais.
-   **Armazenamento de tabelas:**  Armazenar dados estruturados em formato de tabela.

**Azure AI Services:**

-   **Azure Kubernetes Service:**  Gerenciar containers em cluster do Kubernetes.
-   **Azure Functions:**  Criar funções sem servidor para diversos cenários.
-   **Azure Logic Apps:**  Automatizar workflows com integração a diversos serviços.
-   **Azure Event Grid:**  Criar e consumir eventos em tempo real
...
```javascript
{
  "@odata.context": "https://labai900search.search.windows.net/indexes('coffee-index')/$metadata#docs(*)",
  "@odata.count": 9,
  "value": [
    {
      "@search.score": 1,
      ...
      "metadata_storage_path": "aHR0cHM6Ly9sYWJhaTkwMHN0b3JhZ2UuYmxvYi5jb3JlLndpbmRvd3MubmV0L2NvZmZlZS1yZXZpZXdzL3Jldmlldy01LmRvY3g1",
      "locations": [
        "meeting spot",
        "Chicago",
        "Illinois"
    ...
    },
    {
      ...
      "metadata_storage_path": "aHR0cHM6Ly9sYWJhaTkwMHN0b3JhZ2UuYmxvYi5jb3JlLndpbmRvd3MubmV0L2NvZmZlZS1yZXZpZXdzL3Jldmlldy0yLmRvY3g1",
      "locations": [
        "school",
        "University hub",
        "Los Angeles",
    ...
    },
    {
      ...
      "metadata_storage_path": "aHR0cHM6Ly9sYWJhaTkwMHN0b3JhZ2UuYmxvYi5jb3JlLndpbmRvd3MubmV0L2NvZmZlZS1yZXZpZXdzL3Jldmlldy04LmRvY3g1",
      "locations": [
        "Chicago",
        "Illinois"
      ],
    ...
    },
    {
      ...
      "metadata_storage_path": "aHR0cHM6Ly9sYWJhaTkwMHN0b3JhZ2UuYmxvYi5jb3JlLndpbmRvd3MubmV0L2NvZmZlZS1yZXZpZXdzL3Jldmlldy0xLmRvY3g1",
      "locations": [
        "Seattle",
        "Washington"
      ],
    ...
    },
    {
      ...
      "metadata_storage_path": "aHR0cHM6Ly9sYWJhaTkwMHN0b3JhZ2UuYmxvYi5jb3JlLndpbmRvd3MubmV0L2NvZmZlZS1yZXZpZXdzL3Jldmlldy05LmRvY3g1",
      "locations": [
        "Seattle",
        "Washington"
      ],
    ...
    },
    {
      ...
      "metadata_storage_path": "aHR0cHM6Ly9sYWJhaTkwMHN0b3JhZ2UuYmxvYi5jb3JlLndpbmRvd3MubmV0L2NvZmZlZS1yZXZpZXdzL3Jldmlldy0zLmRvY3g1",
      "locations": [
        "Seattle",
        "Washington",
        "Café 50"
      ...
      "imageCaption": [
        "{\"tags\":[\"text\",\"tree\",\"outdoor\",\"person\",\"man\",\"park\"],\"captions\":[{\"text\":\"a man holding a laptop and a bag of money\",\"confidence\":0.27100712060928345}]}",
    ...
    },
    {
      ...
      "metadata_storage_path": "aHR0cHM6Ly9sYWJhaTkwMHN0b3JhZ2UuYmxvYi5jb3JlLndpbmRvd3MubmV0L2NvZmZlZS1yZXZpZXdzL3Jldmlldy00LmRvY3g1",
      "locations": [
        "Fourth Coffee",
        "Chicago",
        "Illinois"
    ...
    },
    {
      ...
      "metadata_storage_path": "aHR0cHM6Ly9sYWJhaTkwMHN0b3JhZ2UuYmxvYi5jb3JlLndpbmRvd3MubmV0L2NvZmZlZS1yZXZpZXdzL3Jldmlldy02LmRvY3g1",
      "locations": [
        "Fourth Coffee",
        "Seattle",
        "Washington"
      ...
      "imageCaption": [
        "{\"tags\":[\"text\",\"person\",\"indoor\"],\"captions\":[{\"text\":\"a couple of girls holding a book\",\"confidence\":0.38007590174674988}]}",
    ...
    },
    {
      ...
      "metadata_storage_path": "aHR0cHM6Ly9sYWJhaTkwMHN0b3JhZ2UuYmxvYi5jb3JlLndpbmRvd3MubmV0L2NvZmZlZS1yZXZpZXdzL3Jldmlldy03LmRvY3g1",
      "locations": [
...
-   **Com apenas queries simples, obtivemos resultados poderosos.**  Filtramos reviews por localização e sentimento,  **desbloqueando insights valiosos e facilitando a análise posterior para uma melhor tomada de decisões.**

-   **Essa capacidade de filtrar com precisão e rapidez nos permitiu:**
    -   **Compreender as percepções dos clientes em diferentes regiões.**
    -   **Avaliar a satisfação geral do cliente com nosso produto ou serviço.**
    -   **Obter insights sobre tópicos específicos de interesse.**

-   **A utilização de queries simples para filtrar reviews é apenas a ponta do iceberg.**  Combinando essa técnica com outras ferramentas de análise de dados, podemos obter uma visão completa das percepções dos clientes e tomar decisões ainda mais informadas.
-   **Este é um passo importante para transformar dados brutos em insights valiosos que podem ser usados para melhorar nosso negócio.**

-   **A capacidade de filtrar reviews com queries simples é um exemplo do poder da IA e da análise de dados.**  Ao usar essas ferramentas, podemos tomar decisões mais inteligentes e eficazes que impulsionam o sucesso do nosso negócio.

**O Desafio de Busca com IA foi uma experiência valiosa que me proporcionou a oportunidade de:**

-   **Aprofundar meus conhecimentos em IA e suas aplicações na busca.**
-   **Desenvolver habilidades práticas em ferramentas de IA da Microsoft.**
